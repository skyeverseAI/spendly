...
1. Verify the spec file exists at `.claude/specs/$ARGUMENTS.md`. If it does not exist, stop immediately and say: "Spec file `.claude/specs/$ARGUMENTS.md` not found. Check the spec name and try again."
